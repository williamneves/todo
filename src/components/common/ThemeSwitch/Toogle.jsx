...
const Toogle = ({isDark, switchTheme}) => {
	return (
		<div className='flex items-center'>
			<label htmlFor='orange-toggle' className='inline-flex relative items-center cursor-pointer'>
        <input type='checkbox' value='' id='orange-toggle' className='sr-only peer' checked={ isDark } onChange={ switchTheme} />
